...
pkgdatadir = $(datadir)/skinxxx
pkgincludedir = $(includedir)/skinxxx
pkglibdir = $(libdir)/skinxxx
pkglibexecdir = $(libexecdir)/skinxxx
...
CONFIG_HEADER = $(top_builddir)/src/config/skinxxx-config.h
...
ACLOCAL = ${SHELL} /home/csadmin/NetBeansProjects/skinxxx/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/csadmin/NetBeansProjects/skinxxx/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/csadmin/NetBeansProjects/skinxxx/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/csadmin/NetBeansProjects/skinxxx/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/csadmin/NetBeansProjects/skinxxx/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/csadmin/NetBeansProjects/skinxxx
abs_srcdir = /home/csadmin/NetBeansProjects/skinxxx
...
install_sh = ${SHELL} /home/csadmin/NetBeansProjects/skinxxx/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/skinxxxd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/skinxxx-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/skinxxx-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = SKINXXX-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_skinxxx_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_skinxxx_coverage.info test_skinxxx.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/skinxxx-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/skinxxx-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/skinxxx-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/skinxxx-config.h
$(top_srcdir)/src/config/skinxxx-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/skinxxx-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/skinxxx-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/skinxxx-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/skinxxx-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_skinxxx.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_skinxxx -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_skinxxx_filtered.info: test_skinxxx.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_skinxxx_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_skinxxx_coverage.info: baseline_filtered_combined.info test_skinxxx_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_skinxxx_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_skinxxx_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_skinxxx_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_skinxxx.coverage/.dirstamp:  test_skinxxx_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_skinxxx.coverage/.dirstamp total.coverage/.dirstamp

# skinxxx: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_skinxxx.coverage/ total.coverage/ $(OSX_APP)
