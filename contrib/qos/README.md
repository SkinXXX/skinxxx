...
This means one can have an always-on colxd instance running, and another local colxd/colx-qt instance which connects to this node and receives blocks from it.
