...
This means one can have an always-on skinxxxd instance running, and another local skinxxxd/skinxxx-qt instance which connects to this node and receives blocks from it.
