...
This means one can have an always-on skind instance running, and another local skind/skin-qt instance which connects to this node and receives blocks from it.
