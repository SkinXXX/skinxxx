UNIX BUILD NOTES
====================
Some notes on how to build SKIN in Unix.

Note
---------------------
Always use absolute paths to configure and compile skin and the dependencies,
...
# Pick some path to install BDB to, here we create a directory within the skin directory
BDB_PREFIX="${SKIN_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
Security
--------
To help make your SKIN installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, skin should be built with a non-executable stack
