...
git clone https://github.com/SkinXXX/skinxxx skinxxx
cd skinxxx
...
```bash
    ...
    From https://github.com/SkinXXX/skinxxx
...
[skin/gitian.sigs](https://github.com/Skinxxx/gitian.sigs/) repository, or if that's not possible to create a pull
request.
