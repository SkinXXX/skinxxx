...
In order to support loading of multiple wallets in colx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is colx.cpp.
...
Changes to colx.cpp
----------------------
colx.cpp is the entry point into colx-qt, and as such, will require some minor modifications to provide hooks for
