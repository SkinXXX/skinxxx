...
In order to support loading of multiple wallets in skinxxx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is skinxxx.cpp.
...
Changes to skinxxx.cpp
----------------------
skinxxx.cpp is the entry point into skinxxx-qt, and as such, will require some minor modifications to provide hooks for
