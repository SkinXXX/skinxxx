...
In order to support loading of multiple wallets in skin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is skin.cpp.
...
Changes to skin.cpp
----------------------
skin.cpp is the entry point into skin-qt, and as such, will require some minor modifications to provide hooks for
