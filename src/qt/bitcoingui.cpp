                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ColossusCoinXT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ColossusCoinXT address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ColossusCoinXT Core"), this);
    aboutAction->setStatusTip(tr("Show information about ColossusCoinXT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ColossusCoinXT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ColossusCoinXT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ColossusCoinXT addresses"));
    ...
    openAction->setStatusTip(tr("Open a ColossusCoinXT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ColossusCoinXT Core help message to get a list with possible ColossusCoinXT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ColossusCoinXT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ColossusCoinXT network", "", count));
}
...
{
    QString strTitle = tr("ColossusCoinXT Core"); // default title
    ...
    // Append title to "ColossusCoinXT - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
