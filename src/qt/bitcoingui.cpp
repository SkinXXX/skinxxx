                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SkinXXX") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a skinxxx address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and skinxxx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SkinXXX"), this);
    aboutAction->setStatusTip(tr("Show information about SkinXXX"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for skinxxx"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your skinxxx addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified skinxxx addresses"));
    ...
    openAction->setStatusTip(tr("Open a skinxxx: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SkinXXX help message to get a list with possible skinxxx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SkinXXX client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to skinxxx network", "", count));
}
...
{
    QString strTitle = tr("SkinXXX"); // default title
