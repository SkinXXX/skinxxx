                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("skinxxx Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About skinxxx Core"), this);
    aboutAction->setStatusTip(tr("Show information about skinxxx Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the skinxxx Core help message to get a list with possible skinxxx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("skinxxx Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("skinxxx Core"); // default title
