...
/** Utility functions used by the skinxxx Qt UI.
 */
namespace GUIUtil
{
...
// Render skinxxx addresses in monospace font
...
// Parse "skinxxx:" URI into recipient object, return true on successful parsing
