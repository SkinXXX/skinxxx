...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pivx Core skin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  skin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded skin transaction") + "\n" +
                               "  skin-tx [options] -create [commands]   " + _("Create hex-encoded skin transaction") + "\n" +
                               "\n";
