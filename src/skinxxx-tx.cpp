...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Skinxxx Core skinxxx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  skinxxx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded skin transaction") + "\n" +
                               "  skinxxx-tx [options] -create [commands]   " + _("Create hex-encoded skin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded skin transaction
